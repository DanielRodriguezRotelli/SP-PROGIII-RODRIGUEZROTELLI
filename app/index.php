...
require_once './middlewares/CheckAgenteMiddleware.php';
require_once './middlewares/CheckClienteMiddleware.php';
...
$app->group('/usuarios', function (RouteCollectorProxy $group) {
  $group->post('/alta', \UsuarioController::class . ':CargarUno')->add(new CheckAgenteMiddleware());
  $group->get('/traerUsuarios', \UsuarioController::class . ':TraerTodos')->add(new CheckAgenteMiddleware());
  $group->get('/traerUsuariosActivos', \UsuarioController::class . ':TraerTodosActivos')->add(new CheckAgenteMiddleware());
  $group->get('/traerUsuarioPorId/{id}', \UsuarioController::class . ':TraerUno');
  $group->put('/modificarUsuario', \UsuarioController::class . ':ModificarUno')->add(new CheckAgenteMiddleware());
  $group->delete('/borrarUsuario/{id}', \UsuarioController::class . ':BorrarUno')->add(new CheckAgenteMiddleware());
...
$app->group('/cuentas', function (RouteCollectorProxy $group) {
  $group->post('/altaCuenta', \CuentaController::class . ':CargarUno')->add(new CheckAgenteMiddleware());
  $group->get('/traerCuentas', \CuentaController::class . ':TraerTodos')->add(new CheckAgenteMiddleware());
  $group->get('/traerCuentasActivas', \CuentaController::class . ':TraerTodosActivos')->add(new CheckAgenteMiddleware());
  $group->get('/traerCuentaPorTipo/{tipoCuenta}', \CuentaController::class . ':TraerUno')->add(new CheckAgenteMiddleware());
  $group->get('/traerCuentaPorTipoId', \CuentaController::class . ':ConsultarCuenta');
  $group->put('/modificarCuenta', \CuentaController::class . ':ModificarUno')->add(new CheckAgenteMiddleware());
  $group->delete('/borrarCuenta/{id}', \CuentaController::class . ':BorrarUno')->add(new CheckAgenteMiddleware());
})->add(new CheckTokenMiddleware());


$app->group('/depositos', function (RouteCollectorProxy $group) {
  $group->post('/altaDeposito', \DepositoController::class . ':CargarUno');
  $group->get('/InformeDepositosPorCuentaYMoneda', \DepositoController::class . ':TotalDepositadoPorCuentaYMoneda')->add(new CheckAgenteMiddleware());
  $group->get('/InformeDepositosPorUsuario/{idUsuario}', \DepositoController::class . ':ListarTotalDepositosPorIdUsuario')->add(new CheckAgenteMiddleware());
  $group->get('/InformeDepositosEntreFechas', \DepositoController::class . ':ListarTotalDepositosOrdenadosEntreDosFechas')->add(new CheckAgenteMiddleware());
  $group->get('/InformeDepositosPorTipoDeCuenta/{tipoCuenta}', \DepositoController::class . ':ListarDepositosPorTipoDeCuenta')->add(new CheckAgenteMiddleware());
  $group->get('/InformeDepositosPorMoneda/{moneda}', \DepositoController::class . ':ListarDepositosPorMoneda')->add(new CheckAgenteMiddleware());
...
$app->group('/retiros', function (RouteCollectorProxy $group) {
  $group->post('/altaRetiro', \RetiroController::class . ':CargarUno');
  $group->get('/InformeRetirosPorCuentaYMoneda', \RetiroController::class . ':TotalRetirosPorCuentaYMoneda')->add(new CheckAgenteMiddleware());
  $group->get('/InformeRetirosPorUsuario/{idUsuario}', \RetiroController::class . ':ListarTotalRetirosPorIdUsuario')->add(new CheckAgenteMiddleware());
  $group->get('/InformeRetirosEntreFechas', \RetiroController::class . ':ListarTotalRetirosOrdenadosEntreDosFechas')->add(new CheckAgenteMiddleware());
  $group->get('/InformeRetirosPorTipoDeCuenta/{tipoCuenta}', \RetiroController::class . ':ListarRetirosPorTipoDeCuenta')->add(new CheckAgenteMiddleware());
  $group->get('/InformeRetirosPorMoneda/{moneda}', \RetiroController::class . ':ListarRetirosPorMoneda')->add(new CheckAgenteMiddleware());
})->add(new CheckTokenMiddleware());

$app->group('/ajustes', function (RouteCollectorProxy $group) {
  $group->post('/altaAjuste', \AjusteController::class . ':CargarUno');
})->add(new CheckTokenMiddleware());

$app->group('/operaciones', function (RouteCollectorProxy $group) {
  $group->get('/InformeOperacionesPorUsuario/{idUsuario}', \OperacionController::class . ':ListarOperacionesPorUsuario')->add(new CheckAgenteMiddleware());
})->add(new CheckTokenMiddleware());
