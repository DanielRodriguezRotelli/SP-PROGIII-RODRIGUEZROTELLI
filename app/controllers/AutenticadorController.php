...
class AutenticadorController extends AutentificadorJWT
{
    public function CrearTokenLogin($request, $response,$args)
    {
        ...
        $usuarioBaseDeDatos=Usuario::obtenerUsuario($parametros["nroDocumento"]);
        echo "Usuario :".$usuarioBaseDeDatos->nombre. "<br>";
        echo "Clave: ".$usuarioBaseDeDatos->clave. "<br>";
        ...
        {       
            ...
            {
                $datos = array('nroDocumento' => $usuarioBaseDeDatos->nroDocumento, "perfil"=> $usuarioBaseDeDatos->perfil);
